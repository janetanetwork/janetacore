...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s janetacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  janetacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded janetacoin transaction") + "\n" +
              "  janetacoin-tx [options] -create [commands]   " + _("Create hex-encoded janetacoin transaction") + "\n" +
              "\n";
