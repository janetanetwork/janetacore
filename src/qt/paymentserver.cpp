...
const char* BIP71_MIMETYPE_PAYMENT = "application/janetacoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/janetacoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/janetacoin-paymentrequest";
